...
3. Запустить сервер (Просто нажать запустить в панели задач) или (XAMPP - включить mysql, apache)
4. Создать свою БД - gruzovik_db (код запросов таблиц ниже).
5. Написать свои стили. + Адаптив.
6. Заскринить что у вас получилось в формате png (рекомендую), либо в создать отдельно файлы в формате html
...
В эту папку вы можете скачивать картинки, оставляю ссылку на тему "Грузовики", чтобы не искать
